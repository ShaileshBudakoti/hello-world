    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        function addVerticalNavigation(){
            $('body').append('<div class="pp-nav"><ul></ul></div>');
            var nav = $('.pp-nav');
            ...
            for(var cont = 0; cont < $('.pp-section').length; cont++){
                ...
                if(options.navigation.tooltips !== ''){
        ...
        */
        $(document).on({
            mouseenter: function(){
                ...
                $('<div class="pp-tooltip ' + options.navigation.position +'">' + + '</div>').hide().appendTo($(this)).fadeIn(200);
            },
            mouseleave: function(){
